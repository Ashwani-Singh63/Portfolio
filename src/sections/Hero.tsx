  ...
  return (
    <section className="min-h-screen flex items-center pt-24 pb-20 px-6">
      ...
      >
        ...
        <motion.h1
          className="text-5xl sm:text-7xl md:text-8xl lg:text-[10rem] font-black text-slate-900 dark:text-white mb-6 md:mb-8 tracking-tighter leading-[0.9] md:leading-[0.85] drop-shadow-sm"
        ...
        <motion.p
          className="text-xl sm:text-2xl md:text-4xl text-slate-600 dark:text-slate-400 font-semibold mb-8 md:mb-12 max-w-3xl mx-auto leading-tight"
          variants={itemVariants}
        >
        ...
        >
          ...
          <motion.a
            href="#contact"
            className="px-8 py-4 md:px-12 md:py-6 backdrop-blur-md bg-slate-200/30 dark:bg-slate-800/40 border border-slate-300/50 dark:border-slate-700 font-black rounded-[1.5rem] hover:bg-slate-200/60 dark:hover:bg-slate-700/60 transition-all text-slate-800 dark:text-white w-full sm:w-auto text-sm md:text-base"
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.98 }}
          >
            Contact Me
