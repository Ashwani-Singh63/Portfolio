  ...
  return (
    <section id="contact" className="py-40 px-6">
      <div className="max-w-5xl mx-auto">
        <SectionReveal>
          <GlassCard className="p-16 md:p-24 relative overflow-hidden text-center bg-slate-900/5 dark:bg-slate-800/40">
            <motion.div 
            ...
            <motion.h2 
              className="text-7xl font-black mb-8 tracking-tighter text-slate-900 dark:text-white leading-none"
            ...
            <motion.p 
              className="text-2xl text-slate-600 dark:text-slate-400 mb-20 max-w-2xl mx-auto font-medium leading-tight"
            ...
            >
              <motion.a 
                ...
                className="group p-10 rounded-[2.5rem] bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 hover:bg-primary-600 transition-all flex flex-col items-center gap-6 flex-1 shadow-lg hover:shadow-primary-500/40 hover:-translate-y-2"
              ...
              >
                ...
                <div className="text-center group-hover:text-white">
                  ...
                  <p className="font-black text-xl tracking-tight text-slate-900 dark:text-white group-hover:text-white">{PERSONAL_INFO.email}</p>
                </div>
              </motion.a>
              ...
              <motion.a 
                ...
                className="group p-10 rounded-[2.5rem] bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 hover:bg-blue-600 transition-all flex flex-col items-center gap-6 flex-1 shadow-lg hover:shadow-blue-500/40 hover:-translate-y-2"
                variants={itemVariants}
                whileHover={{ y: -8, scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
              >
